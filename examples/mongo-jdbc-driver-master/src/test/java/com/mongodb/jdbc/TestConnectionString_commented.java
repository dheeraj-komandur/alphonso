...
// (AI Comment) - Test suite for validating MongoDB connection string parsing and configuration settings.
class TestConnectionString {
    ...
    // (AI Comment) - Tests the connection settings for a local MongoDB instance without additional database properties.
    @Test
    ...
    // (AI Comment) - Verifies that properties override the database specified in the URI when no auth source is provided.
    @Test
    ...
    // (AI Comment) - Helper method to validate MongoDB URI patterns against expected outcomes.
    /**
