...
// (AI Comment) - Represents the OIDC authentication flow, handling authorization and token exchange processes.
public class OidcAuthFlow {
    ...
    // (AI Comment) - Logs messages using either the MongoLogger or the default logger.
    ...
    // (AI Comment) - Handles the refresh token flow, requesting new tokens using a refresh token.
    ...
    // (AI Comment) - Validates the IdP information, ensuring it meets required criteria.
