...
// (AI Comment) - Test class for validating BSON type information retrieval methods.
public class BsonTypeInfoTest {
    @Test
    // (AI Comment) - Tests the retrieval of BSON type information by name, ensuring valid names return expected types and invalid names throw exceptions.
    ...
    @Test
    // (AI Comment) - Tests the retrieval of BSON type information from BSON values, validating that each BSON type returns the correct type information.
