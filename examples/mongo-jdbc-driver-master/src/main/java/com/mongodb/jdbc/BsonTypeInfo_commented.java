...
public enum BsonTypeInfo {
    ...
    // (AI Comment) - Returns the minimum scale for numeric and date-time data.
    public int getMinScale() {
        return minScale;
    }

    // (AI Comment) - Returns the maximum scale for numeric and date-time data.
    ...
    // (AI Comment) - Converts a BsonValue to its corresponding BsonTypeInfo, throwing SQLException for null or unknown types.
    /**
    ...
    // (AI Comment) - Converts a BSON type name to its corresponding BsonTypeInfo, throwing SQLException for null or unknown names.
    /**
